package com.sonictms.alsys.erp.erp102001.entity;
...
public class Erp102001VO extends commonVO {
  ...
  private String smsSender = "01032626945"; // 알림톡 실패시 문자로 발송할때 발송번호(알림톡 업체에 등록되어있는 번호여야함)   //20230401 정연호. 0315269846 을 0315269848 로 변경
  ...
  private String userid = "eusonicdev"; // 알림톡 발송-발송자아이디
