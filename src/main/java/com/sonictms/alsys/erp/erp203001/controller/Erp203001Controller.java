package com.sonictms.alsys.erp.erp203001.controller;

import com.sonictms.alsys.erp.erp203001.entity.Erp203001VO;
import com.sonictms.alsys.erp.erp203001.service.Erp203001Service;
...
public class Erp203001Controller {
    ...
    // 그리드에서 순번, 팔렛트, 시공기사 입력한 것 저장 또는 수정 하기
    @RequestMapping(value = {"erp203001Save"}, method = RequestMethod.POST)
    @ResponseBody
    public List<Erp203001VO> erp203001Save(@RequestBody List<Erp203001VO> erp203001VO) {
        erp203001VO.replaceAll(erp203001Service::erp203001Save);
        return erp203001VO;
    }
