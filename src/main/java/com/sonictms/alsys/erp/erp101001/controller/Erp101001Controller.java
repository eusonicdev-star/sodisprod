...
public class Erp101001Controller {
    ...
    /**
     * 좌표 동기화 (좌표 없는 주문에 대해 생성)
     */
    @ResponseBody
    @PostMapping("/erp101001/syncCoord")
    public Map<String, Object> syncCoord(Erp101001VO vo) {
        Map<String, Object> resultMap = new HashMap<>();
        try {
            // 서비스 호출
            int updateCount = erp101001Service.syncCoordinates(vo);
