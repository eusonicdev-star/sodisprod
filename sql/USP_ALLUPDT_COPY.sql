...
SET @V_NEW_SO_M_ID = @@IDENTITY;
    ...
    ************************************************************************************************************************************/
    INSERT TBL_SO_P
    ( TBL_SO_M_ID, SO_NO, PROD_SEQ, PROD_CD, PROD_NM, QTY
    , INST_COST, UNIT, CUST_PRC, SALE_PRC, FACT_PRC, PURC_PRC
    , SIZE_NM, L, D, H, H2
    , MTRL_CTGR_1, MTRL_CTGR_2, MTRL_CTGR_3
    , SET_YN, BOM_YN, INST_YN
    , INST_CTGR, INST_TYPE, INST_SEAT_TYPE
    , ZONE_TYPE, ZONE_CD
    , DLVY_YN, DLVY_TYPE, DLVY_COST
    , DC_CD, RQST_DT, RQST_MSG, DLVY_CNFM_DT
    , NDLVY_YN, THR_DLVY_YN
    , USE_YN, MEMO
    , SAVE_USER, SAVE_TIME, UPDT_USER, UPDT_TIME
    , REF_SO_NO, DLVY_COST_TYPE, RCPT_COST, PASS_COST)
